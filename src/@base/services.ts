...
export class BaseService<Entity, FilterOptions, CreatePayload, UpdatePayload = CreatePayload>
  implements IBaseService<Entity, FilterOptions, CreatePayload, UpdatePayload>
{
