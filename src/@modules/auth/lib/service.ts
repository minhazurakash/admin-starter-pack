...
export const AuthService = {
  ...
  async forceAccess(payload: IForceAccess): Promise<IBaseResponse<ILoginSession & { accessByToken: string }>> {
    try {
  ...
  async endForceAccess(payload: { accessByToken: string }): Promise<IBaseResponse<ILoginSession>> {
    try {
